            ...
            <div className={styles.container}>
                <div className={styles['breadAndPast-main-content']}>
                    ...
                    <div className={styles['mini-nav-product']}>
                        <Link to="/baby-foods">Храни</Link>
                        <Link to="/baby-drinks">Напитки</Link>
                        <Link to="/baby-cosmetics">Козметика</Link>
                        <Link to="/diapers-and-wet-wipes">Пелени и мокри кърпички</Link>
                        <Link to="/detergents-and-fabric-softeners">Перилни препарати и омекотители</Link>
                    </div>
