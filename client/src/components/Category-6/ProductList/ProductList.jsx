            ...
            <div className={styles.container}>
                <div className={styles['breadAndPast-main-content']}>
                    ...
                    <div className={styles['mini-nav-product']}>
                        <Link to="/coffee-and-tea">Кафе, чай и какао</Link>
                        <Link to="/water">Вода</Link>
                        <Link to="/fresh-and-smoothies">Фрешове, смутита, плодови и зеленчукови напитки</Link>
                        <Link to="/soft-drink">Безалкохолни напитки</Link>
                        <Link to="/energy-drink">Енергийни, витаминозни и изотонични напитки</Link>
                        <Link to="/cider-and-kombucha">Сайдер и комбуча</Link>
                        <Link to="/beer">Бира</Link>
                        <Link to="/wine">Вино</Link>
                        <Link to="/alcohol-drink">Високоалкохолни напитки</Link>
                    </div>
