...
// export const Egg = ({showNavigationAndFooter}) => {
...
//     const currentItems = sortProducts(allEgg).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allEgg.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allEgg.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Яйца</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allEgg.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Egg = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllEgg}
        categoryTitle="Яйца"
    />
);