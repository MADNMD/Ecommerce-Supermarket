...
// export const Cheese = ({showNavigationAndFooter}) => {
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllCheese()
//             .then(cheeses => {
//                 setAllCheese(cheeses);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allCheese).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allCheese.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allCheese.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Сирена</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allCheese.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Cheese = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllCheese}
        categoryTitle="Сирена"
    />
);