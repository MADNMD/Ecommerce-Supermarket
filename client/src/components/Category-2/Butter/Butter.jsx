...
// import styles from './Butter.module.css';
...
// export const Butter = ({showNavigationAndFooter}) => {

//     const [allButter, setAllButter] = useState([]);
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllButter()
//             .then(butters => {
//                 setAllButter(butters);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allButter).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allButter.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allButter.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Масло, сметана и извара</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allButter.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Butter = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllButter}
        categoryTitle="Масло, сметана и извара"
    />
);