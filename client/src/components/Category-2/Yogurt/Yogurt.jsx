...
// import styles from './Yogurt.module.css';
...
// export const Yogurt = ({ showNavigationAndFooter }) => {
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllYogurts()
//             .then(yogurts => {
//                 setAllYogurts(yogurts);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allYogurts).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allYogurts.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allYogurts.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <Link to="/yogurt">Кисели млека</Link>
...
//                         <h3 className={styles.sometimes}>Кисели млека</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allYogurts.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Yogurt = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllYogurts}
        categoryTitle="Кисели млека"
    />
);