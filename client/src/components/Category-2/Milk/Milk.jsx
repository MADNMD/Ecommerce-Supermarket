...
// export const Milk = ({showNavigationAndFooter}) => {
...
//     const currentItems = sortProducts(allMilks).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allMilks.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allMilks.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Пресни млека</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allMilks.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Milk = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllMilk}
        categoryTitle="Пресни млека"
    />
);