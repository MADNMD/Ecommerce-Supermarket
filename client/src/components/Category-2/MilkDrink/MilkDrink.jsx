...
// import styles from './MilkDrink.module.css';
...
// import { CardFirstItem } from "../MilkAndEgg/CardFirstItem";
// import { CardSecondItem } from "../MilkAndEgg/CardSecondItem";

// export const MilkDrink = ({ showNavigationAndFooter }) => {

//     const [allMilkDrink, setAllMilkDrink] = useState([]);
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllMilkDrink()
//             .then(milkDrinks => {
//                 setAllMilkDrink(milkDrinks);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allMilkDrink).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allMilkDrink.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allMilkDrink.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Плодови млека, млечни напитки и десерти</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allMilkDrink.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const MilkDrink = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllMilkDrink}
        categoryTitle="Плодови млека, млечни напитки и десерти"
    />
);