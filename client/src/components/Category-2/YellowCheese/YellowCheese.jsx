...
// import styles from './YellowCheese.module.css';
...
// export const YellowCheese = ({showNavigationAndFooter}) => {

//     const [allYellowCheese, setAllYellowCheese] = useState([]);
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllYellowCheese()
//             .then(yellowCheeses => {
//                 setAllYellowCheese(yellowCheeses);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allYellowCheese).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allYellowCheese.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allYellowCheese.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Кашкавали</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allYellowCheese.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const YellowCheese = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllYellowCheese}
        categoryTitle="Кашкавали"
    />
);