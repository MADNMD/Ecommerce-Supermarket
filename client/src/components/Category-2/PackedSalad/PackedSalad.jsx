...
// import styles from './PackedSalad.module.css';
...
// export const PackedSalad = ({showNavigationAndFooter}) => {

//     const [allPackedSalad, setAllPackedSalad] = useState([]);
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllPackedSalad()
//             .then(packedSalads => {
//                 setAllPackedSalad(packedSalads);
//                 setLoading(false);
//             })
//             .catch(error => {
//                 console.log(error);
...
//     const currentItems = sortProducts(allPackedSalad).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allPackedSalad.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allPackedSalad.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Готови салати</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allPackedSalad.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const PackedSalad = ({ showNavigationAndFooter }) => (
    <ProductList
        ...
        fetchProducts={productService.getAllPackedSalad}
        categoryTitle="Готови салати"
    />
);