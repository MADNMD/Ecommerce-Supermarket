            ...
            <div className={styles.container}>
                <div className={styles['breadAndPast-main-content']}>
                    ...
                    <div className={styles['mini-nav-product']}>
                        <Link to="/bread">Хляб</Link>
                        <Link to="/baguettes-and-trotillas">Багети и тортили</Link>
                        <Link to="/pasta-product">Макаронени изделия</Link>
                        <Link to="/dough-product">Тестени изделия</Link>
                        <Link to="/fresh-pasta">Прясна паста</Link>
                    </div>
