...
// export const MeatProducts = ({ showNavigationAndFooter }) => {

//     const [getAllMeatProducts, setAllMeatProducts] = useState([]);
...
//     useEffect(() => {
//         setLoading(true);
//         productService.getAllMeatProducts()
//             .then(meatProducts => {
//                 setAllMeatProducts(meatProducts);
//                 setLoading(false);
//             })
//             .catch(error => {
...
//     const currentItems = sortProducts(getAllMeatProducts).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(getAllMeatProducts.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(getAllMeatProducts.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Месни продукти</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(getAllMeatProducts.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const MeatProducts = ({ showNavigationAndFooter }) => (
    <ProductList 
        ...
        fetchProducts={productService.getAllMeatProducts} 
        categoryTitle="Месни продукти" 
    />
);
