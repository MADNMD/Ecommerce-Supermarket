...
// export const Fish = ({ showNavigationAndFooter }) => {
...
//     const currentItems = sortProducts(allFish).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allFish.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allFish.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Риба</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allFish.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Fish = ({ showNavigationAndFooter }) => (
    <ProductList 
        ...
        fetchProducts={productService.getAllFish} 
        categoryTitle="Риба" 
    />
);