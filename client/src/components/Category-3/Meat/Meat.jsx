...
// export const Meat = ({ showNavigationAndFooter }) => {
...
//     const currentItems = sortProducts(allMeat).slice(indexOfFirstItem, indexOfLastItem);

//     const nextPage = () => {
//         if (currentPage < Math.ceil(allMeat.length / itemsPerPage)) {
...
//         const totalPages = Math.ceil(allMeat.length / itemsPerPage);
//         const pageNumbers = [];
...
//                         <h3 className={styles.sometimes}>Месо</h3>
...
//                             {renderPageNumbers()}
//                             <button className={styles.next} onClick={nextPage} disabled={currentPage === Math.ceil(allMeat.length / itemsPerPage)}><GoChevronRight /></button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
export const Meat = ({ showNavigationAndFooter }) => (
    <ProductList 
        ...
        fetchProducts={productService.getAllMeat} 
        categoryTitle="Месо" 
    />
);