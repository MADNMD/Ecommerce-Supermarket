            ...
            <div className={styles.container}>
                <div className={styles['breadAndPast-main-content']}>
                    ...
                    <div className={styles['mini-nav-product']}>
                        <Link to="/laundry-detergents">Перилни препарати</Link>
                        <Link to="/cleaning-preparations">Почистващи препарати</Link>
                        <Link to="/papers-napkins-foils-envelopes">Хартии, салфетки, фолиа, пликове</Link>
                        <Link to="/cleaning-products">Средства за почистване</Link>
                        <Link to="/air-fresheners-candles-insecticides">Ароматизатори, свещи, инсектициди</Link>
                        <Link to="/for-home-and-garden">За бита и градината</Link>
                    </div>
